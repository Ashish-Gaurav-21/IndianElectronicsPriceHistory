...
def extract_data(url):
    ...
    for product_url in product_urls:
        ...
        product_dict = {}
        product_dict['product_id'] = soup.find('input', {'name': 'comment_post_ID'}).get('value', 'n/a') if soup.find('input', {'name': 'comment_post_ID'}) else 'n/a'
        ...
        product_dict['stock_status'] = 'Out of Stock' if soup.select('.out-of-stock') else 'In Stock'
...
url = 'https://www.pcbworldtech.com/product-category/pre-build-pc/'

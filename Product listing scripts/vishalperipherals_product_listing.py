...
# pagination_url = 'https://www.vishalperipherals.in/index.php?route=product/category&path=143_65' # ssd
pagination_url = 'https://www.vishalperipherals.in/index.php?route=product/category&path=25_77' # processor
# pagination_url = 'https://www.vishalperipherals.in/index.php?route=product/category&path=25_98' # graphics card

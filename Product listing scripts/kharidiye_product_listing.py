...
def extract_data(pagination_url):
    ...
    for product in soup.select('ul.products li.product'):
        ...
        product_dict['stock_status'] = 'Out of Stock' if [i for i in product.attrs.get('class', ['n/a']) if 'outofstock' in i.lower()] else 'In Stock'
...
# pagination_url = 'https://www.kharidiye.com/category/computers-and-laptops/storage/'
# pagination_url = 'https://www.kharidiye.com/category/computers-and-laptops/processors/'
pagination_url = 'https://www.kharidiye.com/category/computers-and-laptops/graphics-card/'
